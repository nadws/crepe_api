...
class Point_kerja extends Controller
{
    ...
    public function tambah_ket(Request $request)
    {
        ...
        return redirect()->route('setOrang', ['id_lokasi' => $request->id_lokasi])->with('sukses', 'Data berhasil ditambahkan');
    }
    ...
    public function hapus_ket(Request $request)
    {
        ...
        return redirect()->route('setOrang', ['id_lokasi' => $request->id_lokasi])->with('sukses', 'Data berhasil dihapus');
    }
}

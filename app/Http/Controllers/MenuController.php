        ...
        if (empty($id_menus)) {
            ...
            if (Auth::user()->jenis == 'adm') {
                ...
                $data = [
                    ...
                    'menu' => DB::table('mHandicap')->join('tb_station', 'tb_station.id_station', 'mHandicap.id_station')->where('mHandicap.lokasiMenu', $request->id_lokasi)->get(),
...
// WHERE a.lokasiMenu = $request->id_lokasi"),
    ...
    public function cariMenu(request $request)
    {
        ...
        $data = [
            'menu' => DB::select("SELECT a.aktif,a.tipe,a.id_menu,a.nm_menu,a.lokasi,a.kd_menu,b.kategori,b.kd_kategori,c.id_station,c.nm_station,d.id_handicap,d.handicap,d.point FROM `tb_menu` as a
LEFT JOIN tb_kategori as b ON a.id_kategori = b.kd_kategori
LEFT JOIN tb_station as c ON a.id_station = c.id_station

                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <select name="id_handicap" id="" class="form-control select">
                                                    ...
                                                    @foreach ($handicap as $ha)
                                                        <option {{$ha->id_handicap == $menu->id_handicap ? 'selected' : ''}} value="{{ $ha->id_handicap }}">{{ $ha->handicap }} ({{$ha->point}} Point)</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mb-2">
                                                ...
                                                <input type="text" readonly name="kd_menu" class="form-control"
                                                    placeholder="Kode Menu" value="{{ $menu->kd_menu }}">
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                                <label for="">
                                                    <dt>Nama Menu</dt>
                                                ...
                                                <input type="text" name="nm_menu" class="form-control"
                                                    placeholder="Nama Menu" value="{{ $menu->nm_menu }}">
                                            </div>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <Select class="form-control select" name="id_station">
                                                    ...
                                                    @endphp
                                                    @foreach ($st as $s)
                                                        <option {{$s->id_station == $menu->id_station ? 'selected' : ''}} value="{{ $s->id_station }}">{{ $s->nm_station }}</option>
                                                    @endforeach
                                                </Select>
                                            </div>
                                            @php

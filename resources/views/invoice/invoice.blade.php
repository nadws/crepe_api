                                ...
                                <div class="table-responsive">
                                    ...
                                    foreach ($invoice as $inv) : ?>
                                            <tr>
                                                ...
                                                <td><?= $inv->nm_meja ?></td>
                                                <td>
                                                    <?php if($inv->total_orderan + $inv->bayar - $inv->voucher - $inv->discount < 0): ?>
                                                    0
                                                    <?php else: ?>
                                                    <?= number_format($inv->total_orderan + $inv->bayar - $inv->voucher  , 0) ?>
                                                    <?php endif ?>
                                                 
                                                </td>
                                                <td><?= number_format($inv->total_bayar, 0) ?>
                                                </td>
